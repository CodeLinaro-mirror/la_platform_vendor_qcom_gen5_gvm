...
ifeq ($(strip $(BOARD_DYNAMIC_PARTITION_ENABLE)),true)
 ...
 LOCAL_MODULE_CLASS := ETC
 ifeq ($(ENABLE_AB), true)
   LOCAL_SRC_FILES := fstab/nord/fstab_AB_dynamic_partition_variant.nord_hqx.qti
 else
   LOCAL_SRC_FILES := fstab/nord/fstab_non_AB_dynamic_partition_variant.nord_hqx.qti
 endif #ENABLE_AB
 ...
 LOCAL_MODULE_CLASS := ETC
 ifeq ($(ENABLE_AB), true)
   LOCAL_SRC_FILES := fstab/nord/fstab_AB_dynamic_partition_variant.nord_hgy.qti
 else
   LOCAL_SRC_FILES := fstab/nord/fstab_non_AB_dynamic_partition_variant.nord_hgy.qti
 endif #ENABLE_AB
 LOCAL_MODULE_PATH  := $(TARGET_OUT_VENDOR_ETC)
 include $(BUILD_PREBUILT)
else
 ...
 LOCAL_MODULE       := fstab.hqx.nord.qcom
 LOCAL_MODULE_CLASS := ETC
 LOCAL_SRC_FILES    := fstab.gen5.qti
 LOCAL_MODULE_PATH  := $(TARGET_OUT_VENDOR_ETC)
